...
function makeLoadArgs(lang: string) {
  const fullUrl = `https://voorvoet.nl/${lang}/kontakt`;
...
describe('[lang=lang]/kontakt/+page.server.ts', () => {
  it('returns form, meta, and alternates for de/kontakt', async () => {
  ...
  it('throws 404 when nl lang tries to use kontakt slug', async () => {
