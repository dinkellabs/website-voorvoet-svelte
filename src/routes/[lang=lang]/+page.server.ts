...
import { podiatristLD } from '$lib/seo/structured-data.js';
...
export const load: PageServerLoad = ({ params, url }) => {
  ...
  // Organization is emitted site-wide via the root layout; the home page
  // adds the practice-specific MedicalBusiness ("Podiatrist") block.
  const structuredData = [podiatristLD()];
